...
export default function AdminAboutPageGuarded() {
  return <PageGuard pageKey="about"><AdminAboutPage /></PageGuard>;
}
...
function AdminAboutPage() {
  ...
  const { loading } = useAdminData(fetchAbout);
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.containerContent}>
      ...
      <View style={styles.descBox}>
        ...
        <Text style={styles.descText}>
          This content is displayed on the About page in the app
        </Text>
      </View>
